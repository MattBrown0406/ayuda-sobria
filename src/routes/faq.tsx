...
const FAQS = [
  { q: "¿La reunión del Círculo Familiar realmente es gratis?", a: "Sí. La reunión semanal del lunes 8:00 PM PT no tiene costo. Solo necesitas el enlace de Zoom." },
...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Respuestas rápidas sobre el Círculo Familiar, coaching, intervención y membresía en AyudaSobria." },
      { property: "og:title", content: "Preguntas frecuentes — AyudaSobria" },
      { property: "og:description", content: "Lo básico que las familias preguntan antes de empezar." },
  ...
  component: () => (
    <>
      <PageHero eyebrow="Preguntas" title="Preguntas frecuentes" description="Lo que las familias preguntan antes de empezar." />
