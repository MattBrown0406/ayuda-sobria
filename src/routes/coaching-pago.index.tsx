  ...
  head: () => ({
    meta: [
      { title: "Reservar coaching familiar — AyudaSobria" },
      {
        name: "description",
        content:
          "Paga una sesión privada de coaching familiar en español con Matt Brown. US$150 público, US$125 miembros.",
      },
...
type Pricing = {
  isMember: boolean;
  sessions: Record<SessionType, { label: string; price: string }>;
};
    ...
    <>
      ...
      <div className="mx-auto grid max-w-5xl gap-8 px-4 py-12 lg:grid-cols-2">
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <p>
            Sesión privada por videollamada segura. Traduce tu situación en pasos concretos:
            límites, comunicación, intervención y siguientes acciones.
          </p>
          <div className="rounded-lg border border-border bg-card p-4">
            ...
            {isMember && (
              <p className="mt-3 text-xs text-emerald-700">✓ Precio de miembro aplicado.</p>
            )}
          </div>
          <p>
            ...
            o escribe a{" "}
            <a href="mailto:matt@soberhelpline.com" className="font-medium text-primary">
