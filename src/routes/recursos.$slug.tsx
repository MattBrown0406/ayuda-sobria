  ...
  return (
    <>
      ...
      <Prose>
        ...
        <p>
          La adicción no afecta solo a la persona que consume. Cambia la manera en que la familia
          duerme, decide, gasta, se comunica y confía. Entender <em>{topic.title.toLowerCase()}</em>{" "}
          te ayuda a dejar de reaccionar y empezar a responder.
        </p>
        <h2>Qué observar</h2>
        <ul>
        ...
        <ol className="mt-4 list-decimal pl-6 space-y-2">
          <li>
            Únete a La Sobremesa del lunes a las 8:00 PM (PT) para escuchar a otras familias y
            ordenar tus ideas.
          </li>
          <li>
            Escribe la decisión concreta que tienes pendiente y llévala al grupo o a una sesión
            privada.
          </li>
          <li>
            Comparte esta guía con la persona de la familia que necesita entender lo mismo que tú.
          </li>
        </ol>
        <h2>Cuándo pasar a coaching privado</h2>
        <p>
          Si la situación no puede esperar al lunes — hay riesgo de seguridad, una decisión de
          tratamiento urgente, o la familia está dividida — reserva una{" "}
          <Link to="/coaching-familiar">sesión de coaching privado</Link>. Cuando el rechazo al
          tratamiento y la recaída son parte del patrón, evalúa la{" "}
