...
function ToolPage() {
  ...
  return (
    <>
      <PageHero eyebrow="Coach con IA" title={tool.title} description={tool.blurb} />
      <Prose>
        <h2>Para qué sirve</h2>
        <p>Esta herramienta con IA está pensada para familias hispanohablantes que necesitan ordenar una decisión concreta cuando el Círculo Familiar todavía no empieza y no hay una sesión de coaching a la mano.</p>
        <h2>Cómo usarla</h2>
        <ol>
        ...
        <p>La IA no sustituye orientación profesional. Es un espacio para pensar en voz alta y llegar mejor preparado al siguiente paso.</p>
        <p>Ver todas las <Link to="/herramientas-ia">herramientas con IA</Link>.</p>
      </Prose>
      <CTAStrip />
    </>
  );
