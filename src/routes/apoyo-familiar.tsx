  ...
  head: () => ({
    meta: [
      { title: "Apoyo familiar por estado — AyudaSobria" },
      {
        name: "description",
        content:
          "Encuentra apoyo en español para familias afectadas por la adicción en tu estado y ciudad de Estados Unidos.",
      },
  ...
  return (
    <>
      <PageHero
        ...
        description="Familias de todo Estados Unidos usan AyudaSobria. La reunión del Círculo Familiar es en línea y accesible desde cualquier estado."
      />
          ...
          {STATES.map((s) => (
            ...
            >
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                {s.cities.length} ciudades cubiertas
              </p>
            </Link>
          ))}
        </div>
